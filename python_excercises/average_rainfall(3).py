...
def calc_average(list):
    ...
    return totalSum / numOfData
    
aurukunAvg = calc_average(aurukun)
burdekinAvg = calc_average(burdekin)
cardwellAvg = calc_average(cardwell)
daintreeAvg = calc_average(daintree)
tullyAvg = calc_average(tully)

print("The Highest Average Rainfall is: " + str(max(aurukunAvg, burdekinAvg, cardwellAvg, daintreeAvg, tullyAvg)) + "mm")
